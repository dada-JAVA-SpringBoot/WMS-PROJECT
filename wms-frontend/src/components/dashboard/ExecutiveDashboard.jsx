    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm h-[390px] flex flex-col min-h-0 transition-colors">
                    <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-4">{t('pages.ExecutiveDashboard.goodsFlow')}</h3>
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm h-[390px] flex flex-col min-h-0 transition-colors">
                    <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-4">{t('pages.ExecutiveDashboard.stockByCategory')}</h3>
                    <div className="flex-1 min-h-0">
                        <GroupedBarChart 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* Top Products Card */}
                <div className="md:col-span-2 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden transition-colors">
                    <div className="p-4 border-b border-gray-50 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
                        <h3 className="font-bold text-gray-800 dark:text-gray-100">{t('pages.ExecutiveDashboard.topStockProducts')}</h3>
                    </div>
                    <div className="overflow-auto">
                        <table className="w-full text-sm text-left">
                            <thead className="bg-gray-50 dark:bg-gray-700/50 text-gray-400 dark:text-gray-500 uppercase text-[10px] font-bold">
                                <tr>
                            ...
                            <tbody className="divide-y divide-gray-50 dark:divide-gray-700/50">
                                {stats?.topStockProducts?.map((p, idx) => (
                                    <tr key={idx} className="hover:bg-blue-50/20 dark:hover:bg-gray-700/30 transition-colors">
                                        <td className="px-6 py-4 font-medium text-gray-800 dark:text-gray-200">{p.name}</td>
                                        <td className="px-6 py-4 text-gray-500 dark:text-gray-400 font-mono text-xs">{p.sku}</td>
                                        <td className="px-6 py-4 text-right font-black text-[#1192a8] dark:text-[#38bcd4]">{p.totalStock}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
