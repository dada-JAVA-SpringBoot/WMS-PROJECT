        ...
        return (
            <div className="flex flex-col">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-black uppercase tracking-tighter text-red-600 dark:text-red-400">{t('pages.Staff.statusDot.inShift')}</span>
                </div>
                <span className="text-[9px] text-gray-400 dark:text-gray-500 font-bold ml-4.5 leading-none uppercase">{t('pages.Staff.statusDot.notCheckedIn')}</span>
            </div>
        );
    }
    ...
    if (status !== 'ON_SHIFT') {
        return (
            <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-black uppercase tracking-tighter text-gray-400 dark:text-gray-500 font-bold">{t('pages.Staff.statusDot.offline')}</span>
            </div>
        );
    }
    ...
    if (isOnline) {
        return (
            <div className="flex items-center gap-2 group">
                ...
                <div className="flex flex-col">
                    <span className="text-xs font-black uppercase tracking-tighter text-green-600 dark:text-green-400">{t('pages.Staff.statusDot.working')}</span>
        ...
        return (
            <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                    <span className="text-xs font-black uppercase tracking-tighter text-gray-400 dark:text-gray-500 font-bold">{t('pages.Staff.statusDot.working')}</span>
...
export default function Staff({ onCreateInbound, onCreateOutbound }) {
    ...
    return (
        <div className="p-4 lg:p-8 bg-gray-50 dark:bg-gray-900 min-h-full flex flex-col text-left transition-colors duration-300">
            <h1 className="text-xl lg:text-2xl font-black text-gray-800 dark:text-gray-100 mb-6 uppercase tracking-tight">{t('pages.Staff.title')}</h1>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-[32px] shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden flex-1 flex flex-col transition-colors duration-300">
                <div className="overflow-x-auto flex-1 no-scrollbar lg:scrollbar-thin">
                    {loading ? (
                        <div className="flex items-center justify-center h-48 text-gray-400 dark:text-gray-500 text-[10px] font-black uppercase tracking-[0.2em] animate-pulse">{t('pages.Staff.table.loading')}</div>
                    ) : (
                        <table className="w-full text-left border-collapse min-w-[1000px]">
                            ...
                            <tbody className="divide-y divide-gray-50 dark:divide-gray-700/50">
                                {filtered.length === 0 ? (
                                    <tr><td colSpan={7} className="px-6 py-20 text-center text-gray-300 dark:text-gray-600 text-xs font-medium italic">{t('pages.Staff.table.noData')}</td></tr>
                                    ...
                                    <tr key={row.id}
                                        ...
                                        <td className="px-6 py-4">
                                            ...
                                            <p className="text-[10px] text-gray-400 dark:text-gray-500 italic">@{row.username || t('pages.Staff.usernamePlaceholder')}</p>
                                        </td>
