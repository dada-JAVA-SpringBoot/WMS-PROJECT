        ...
        <section className="py-24 bg-[#f4f8fb]">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="text-center mb-20 max-w-4xl mx-auto">
                    <h2 className="text-4xl font-black mb-10 text-[#002f5d]">{t('pages.About.title')}</h2>
                    <div className="bg-[#1192a8]/5 p-12 rounded-[3rem] border border-[#1192a8]/10">
                        ...
                        <div className="mt-12 flex justify-around border-t border-gray-200 pt-10">
                            <div>
                                ...
                                <div className="text-gray-500 text-sm">{t('pages.About.statsCustomers')}</div>
                            </div>
                            <div>
                                <div className="text-3xl font-black text-[#1192a8]">10+</div>
                                <div className="text-gray-500 text-sm">{t('pages.About.statsExperience')}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* sứ mệnh */}
                <div className="mb-32">
                    <h2 className="text-4xl font-bold text-center text-[#002f5d] mb-16">{t('pages.About.missionTitle')}</h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                        <div>
                            <h3 className="text-2xl font-bold text-[#002f5d] mb-4">{t('pages.About.missionPurposeTitle')}</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                        ...
                        <div className="order-1 md:order-2">
                            <h3 className="text-2xl font-bold text-[#002f5d] mb-4">{t('pages.About.missionLifeTitle')}</h3>
                            <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                        <div>
                            <h3 className="text-2xl font-bold text-[#002f5d] mb-4">{t('pages.About.missionStanceTitle')}</h3>
                            <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                        ...
                        <div className="order-1 md:order-2">
                            <h3 className="text-2xl font-bold text-[#002f5d] mb-4">{t('pages.About.missionWorkplaceTitle')}</h3>
                            <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            <h3 className="text-2xl font-bold text-[#002f5d] mb-4">{t('pages.About.missionCommitmentTitle')}</h3>
                            <p className="text-gray-600 leading-relaxed">
                ...
                <div className="mb-32 text-center">
                    <h2 className="text-4xl font-bold text-[#002f5d] mb-4">{t('pages.About.visionTitle')}</h2>
                ...
                <div>
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-[#002f5d] mb-4">{t('pages.About.coreValuesTitle')}</h2>
                        <p className="text-[#00a651] font-semibold text-lg">
                            {t('pages.About.coreValuesSubtitle')}
                        </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                        <div>
                            <h3 className="text-2xl font-bold text-[#002f5d] mb-4">{t('pages.About.coreValuesCustomerTitle')}</h3>
                            <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                        ...
                        <div className="order-1 md:order-2">
                            <h3 className="text-2xl font-bold text-[#002f5d] mb-4">{t('pages.About.coreValuesQualityTitle')}</h3>
                            <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                        <div>
                            <h3 className="text-2xl font-bold text-[#002f5d] mb-4">{t('pages.About.coreValuesTeamworkTitle')}</h3>
                            <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                        ...
                        <div className="order-1 md:order-2">
                            <h3 className="text-2xl font-bold text-[#002f5d] mb-4">{t('pages.About.coreValuesIntegrityTitle')}</h3>
                            <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            <h3 className="text-2xl font-bold text-[#002f5d] mb-4">{t('pages.About.coreValuesResponsibilityTitle')}</h3>
                            <p className="text-gray-600 leading-relaxed">
