    ...
    return (
        <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
            ...
            <div className="text-center py-20 bg-gray-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 transition-colors duration-300">
                ...
                <h3 className="text-4xl font-black text-gray-900 dark:text-white">{t('pages.Features.title')}</h3>
            </div>
            ...
            <div className="max-w-[1200px] mx-auto px-6 py-20 space-y-32">
                    ...
                    <div className="space-y-6 order-2 lg:order-1">
                        ...
                        <ul className="space-y-6 text-gray-600 dark:text-gray-300">
                            <li>
                                ...
                                <p className="ml-9 text-sm text-gray-500 dark:text-gray-400">{t('pages.Features.secWarehouseBullet1Desc')}</p>
                            </li>
                            <li>
                                <div className="flex items-center gap-3 font-bold text-gray-900 dark:text-white mb-1">
                                    <span className="text-green-500 bg-green-50 dark:bg-green-900/30 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg></span>
                                ...
                                <p className="ml-9 text-sm text-gray-500 dark:text-gray-400">{t('pages.Features.secWarehouseBullet2Desc')}</p>
                            </li>
                            <li>
                                <div className="flex items-center gap-3 font-bold text-gray-900 dark:text-white mb-1">
                                    <span className="text-green-500 bg-green-50 dark:bg-green-900/30 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg></span>
                                ...
                                <p className="ml-9 text-sm text-gray-500 dark:text-gray-400">{t('pages.Features.secWarehouseBullet3Desc')}</p>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">{t('pages.Features.secInOutSubtitle')}</p>
                        <ul className="space-y-5 text-gray-600 dark:text-gray-300">
                            <li>
                                <div className="flex items-center gap-3 font-bold text-gray-900 dark:text-white mb-1">
                                    <span className="text-green-500 bg-green-50 dark:bg-green-900/30 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg></span>
                                ...
                                <p className="ml-9 text-sm text-gray-500 dark:text-gray-400">{t('pages.Features.secInOutBullet1Desc')}</p>
                            </li>
                            <li>
                                <div className="flex items-center gap-3 font-bold text-gray-900 dark:text-white mb-1">
                                    <span className="text-green-500 bg-green-50 dark:bg-green-900/30 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg></span>
                                ...
                                <p className="ml-9 text-sm text-gray-500 dark:text-gray-400">{t('pages.Features.secInOutBullet2Desc')}</p>
                            </li>
                            <li>
                                <div className="flex items-center gap-3 font-bold text-gray-900 dark:text-white mb-1">
                                    <span className="text-green-500 bg-green-50 dark:bg-green-900/30 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg></span>
                                ...
                                <p className="ml-9 text-sm text-gray-500 dark:text-gray-400">{t('pages.Features.secInOutBullet3Desc')}</p>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div className="space-y-6 order-2 lg:order-1">
                        ...
                        <ul className="space-y-6 text-gray-600 dark:text-gray-300">
                            <li>
                                ...
                                <p className="ml-9 text-sm text-gray-500 dark:text-gray-400">{t('pages.Features.secPartnerBullet1Desc')}</p>
                            </li>
                            <li>
                                <div className="flex items-center gap-3 font-bold text-gray-900 dark:text-white mb-1">
                                    <span className="text-green-500 bg-green-50 dark:bg-green-900/30 rounded-full p-1"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg></span>
                                ...
                                <p className="ml-9 text-sm text-gray-500 dark:text-gray-400">{t('pages.Features.secPartnerBullet2Desc')}</p>
                            </li>
                        </ul>
                    </div>
