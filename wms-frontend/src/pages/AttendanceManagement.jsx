    ...
    return (
        <div className="p-4 md:p-8 bg-[#f8f9fa] dark:bg-gray-900 min-h-full flex flex-col no-scrollbar transition-colors duration-300">
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 mb-6 md:mb-8 transition-all">
                <div>
                    <h1 className="text-xl md:text-2xl font-black text-gray-800 dark:text-gray-100 uppercase tracking-tight">
                        Quản lý chấm công
                    </h1>
                    <p className="text-gray-500 dark:text-gray-400 text-xs md:text-sm font-medium">
                        Duyệt lý do đi trễ và xem lịch sử toàn nhân viên
                    </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-3 md:p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row gap-2 md:gap-3 shrink-0 transition-colors duration-300">
                    <div className="flex gap-2">
                        <div className="flex-1 sm:flex-none">
                            <p className="text-[8px] font-black text-gray-400 dark:text-gray-500 uppercase ml-1 mb-0.5">Từ ngày</p>
                            <input
                                type="date"
                        ...
                        <div className="flex-1 sm:flex-none">
                            <p className="text-[8px] font-black text-gray-400 dark:text-gray-500 uppercase ml-1 mb-0.5">Đến ngày</p>
                            <input
                                type="date"
                                className="w-full px-3 py-2 rounded-xl border border-gray-100 dark:border-gray-600 text-xs font-bold outline-none focus:border-[#1192a8] transition-all bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200"
                                value={filters.end}
                        ...
                        {loading ? (
                            ...
                            <tr key={idx} className="hover:bg-blue-50/30 dark:hover:bg-gray-700/30 transition-colors group">
                                ...
                                <td className="px-5 md:px-6 py-4">
                                    {row.lateMinutes > 0 ? (
                                        <div className="flex flex-col">
                                            <span className="text-sm text-red-500 dark:text-red-400 font-black">{row.lateMinutes} phút</span>
                                ...
                                <td className="px-5 md:px-6 py-4 max-w-xs">
                                    {row.lateReason && (
                                        <p className="text-xs text-gray-700 dark:text-gray-300 font-bold bg-orange-50 dark:bg-orange-900/20 px-2.5 py-1 rounded-lg inline-block border border-orange-100 dark:border-orange-800 italic">
                                            "{row.lateReason}"
                                        </p>
                                    )}
                                    {row.note && (
                                        <p className="text-[10px] text-gray-400 dark:text-gray-500 font-medium italic mt-1.5">
                                            Phản hồi: {row.note}
                                        </p>
                                    )}
                                </td>
                                <td className="px-5 md:px-6 py-4 text-right">
                                    {row.lateMinutes > 0 && row.approvalStatus === 'PENDING' ? (
                                        ...
                                        <span className="text-gray-300 dark:text-gray-600 text-[10px] font-bold uppercase tracking-tighter">Hoàn tất</span>
                                    )}
                                </td>
                            </tr>
                        ))}
                ...
                <div className="fixed inset-0 bg-black/40 backdrop-blur-md z-50 flex items-center justify-center p-2 md:p-4">
                    <div className="bg-white dark:bg-gray-800 rounded-3xl w-full max-w-md shadow-2xl overflow-hidden flex flex-col max-h-[98vh] animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="p-5 md:p-6 border-b dark:border-gray-700 shrink-0 bg-[#1192a8]">
                            <h3 className="text-base md:text-lg font-black text-white text-center uppercase tracking-widest">
                                Duyệt lý do đi trễ
                            </h3>
                        ...
                        <div className="p-5 md:p-6 space-y-5 overflow-y-auto flex-1">
                            ...
                            <div>
                                <label className="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-2 block ml-1">
                                    Ghi chú của quản lý (Phản hồi)
                                </label>
                                <textarea
