...
export default function Supplier({ onCreateInbound }) {
    ...
    return (
        <div className="p-4 md:p-8 bg-[#f8f9fa] h-full flex flex-col no-scrollbar">
            <h1 className="text-xl md:text-2xl font-black text-gray-800 mb-4 md:mb-6 uppercase tracking-tight">{t('pages.Supplier.title')}</h1>
            ...
            <div className="sticky top-0 z-20 flex items-center justify-between bg-white p-4 md:p-5 rounded-2xl md:rounded-3xl shadow-sm border border-gray-100 mb-4 md:mb-6">
                ...
                <div className="text-xs font-black text-gray-300 uppercase tracking-widest hidden lg:block ml-4">{t('pages.Supplier.category')}</div>
            </div>
                    ...
                    <table className="w-full text-left border-collapse min-w-[800px] md:min-w-[1000px]">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {loading ? (
                                ...
                                <tr><td colSpan={6} className="px-6 py-20 text-center text-gray-400 italic font-medium">{t('pages.Supplier.noData')}</td></tr>
            ...
            {selectedIds.length > 0 && (
                <div className="mt-4 flex justify-between items-center bg-[#1192a8]/5 px-4 py-2 rounded-xl border border-[#1192a8]/10 animate-in slide-in-from-bottom-2 duration-300">
                    <span className="text-[10px] md:text-xs text-gray-500 font-bold uppercase">{t('pages.Supplier.status')} <span className="text-[#1192a8] font-black">{t('pages.Supplier.selectedCount', { count: selectedIds.length })}</span></span>
